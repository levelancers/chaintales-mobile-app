    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.welcomeContainer}>
        {user ? (
          ...
          <Text style={styles.welcomeText}>Chaintales</Text>
        )}
      ...
      <TouchableOpacity style={styles.navigationButton} onPress={() => navigation.navigate("Profile") }>
        ...
        <TouchableOpacity style={styles.navigationButton} onPress={() => navigation.navigate("Stories") }>
          <Text style={styles.navigationText}>Stories</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navigationButton} onPress={() => navigation.navigate("AddStory") }>
          <Text style={styles.navigationText}>Add Story</Text>
        </TouchableOpacity>
      </View>
